...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      {/* STICKY HEADER — sits at hero bottom, then docks to top on scroll */}
      <header className="sticky top-0 z-40 -mt-20 px-6 py-3 bg-background/70 backdrop-blur-xl border-b border-border/40">
